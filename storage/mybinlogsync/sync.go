...
func (c *Canal) startSyncBinlog() error {
	pos := mysql.Position{Name: c.master.Name, Pos: c.master.Position}
...
func (c *Canal) handleRowsEvent(e *replication.BinlogEvent) error {
	...
	if !ok {
		return errors.Errorf("[mybinlogsync] handleRowsEvent: Failed to cast to *replication.RowsEvent type")
	}
