...
func init() {
	...
	tableMap.Append(
		...
		csdb.NewTable(
			...
			csdb.Column{
				...
				Key:     dbr.InitNullString("MUL"),
				Default: dbr.InitNullString("0"),
				Extra:   dbr.InitNullString(""),
			},
			csdb.Column{
				Field:   dbr.InitNullString("path"),
				Type:    dbr.InitNullString("varchar(255)"),
	...
	tableMap.Append(table4, csdb.NewTable(
		"admin_user",
		csdb.Column{
			Field:   dbr.InitNullString("user_id"),
			Type:    dbr.InitNullString("int(10) unsigned"),
			Null:    dbr.InitNullString("NO"),
			Key:     dbr.InitNullString("PRI"),
			Default: dbr.NullString{},
			Extra:   dbr.InitNullString("auto_increment"),
		},
		csdb.Column{
			Field:   dbr.InitNullString("email"),
			Type:    dbr.InitNullString("varchar(128)"),
			Null:    dbr.InitNullString("YES"),
			Key:     dbr.InitNullString(""),
			Default: dbr.NullString{},
			Extra:   dbr.InitNullString(""),
		...
		csdb.Column{
			Field:   dbr.InitNullString("username"),
			Type:    dbr.InitNullString("varchar(40)"),
			Null:    dbr.InitNullString("YES"),
			Key:     dbr.InitNullString("UNI"),
			Default: dbr.NullString{},
			Extra:   dbr.InitNullString(""),
		},
	),
