...
var (
	...
	_ gob.GobEncoder             = (*Int16)(nil)
	_ gob.GobDecoder             = (*Int16)(nil)
...
func TestMakeNullInt16(t *testing.T) {
	...
	assert.Exactly(t, 8, MakeInt16(125).Size())
	assert.Exactly(t, 8, MakeInt16(128).Size())
...
func TestNullInt16_BinaryEncoding(t *testing.T) {
	...
	t.Run("-987654161", runner(MakeInt16(-math.MaxInt16), []byte("\x01\x80\x00\x00\x00\x00\x00\x00")))
	t.Run("987654161", runner(MakeInt16(math.MaxInt16), []byte("\xff\u007f\x00\x00\x00\x00\x00\x00")))
	t.Run("-maxInt16", runner(MakeInt16(-math.MaxInt16), []byte("\x01\x80\x00\x00\x00\x00\x00\x00")))
	t.Run("maxInt16", runner(MakeInt16(math.MaxInt16), []byte("\xff\u007f\x00\x00\x00\x00\x00\x00")))
	t.Run("null", runner(Int16{}, nil))
}
