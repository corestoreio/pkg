...
type (
	// TableProductEntityDecimalSlice contains pointers to TableProductEntityDecimal types
	// +gen slice:"Where,Count"
	TableProductEntityDecimalSlice []*TableProductEntityDecimal
	// TableProductEntityDecimal a type for the MySQL table catalog_product_entity_decimal
	TableProductEntityDecimal struct {
