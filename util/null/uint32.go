...
func MakeUint32(i uint32, valid bool) Uint32 {
	return Uint32{
...
func (i *Uint32) UnmarshalJSON(data []byte) error {
	...
	case nil:
		...
		return nil
	default:
		err = errors.NewNotValidf("[null] json: cannot unmarshal %#v into Go value of type null.Uint32", v)
	}
	i.Valid = err == nil
	return err
}
