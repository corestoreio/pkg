...
func MakeUint16(i uint16, valid bool) Uint16 {
	return Uint16{
...
func (i *Uint16) UnmarshalJSON(data []byte) error {
	...
	case nil:
		...
		return nil
	default:
		err = errors.NewNotValidf("[null] json: cannot unmarshal %#v into Go value of type null.Uint16", v)
	}
	i.Valid = err == nil
	return err
}
