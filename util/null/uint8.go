...
func MakeUint8(i uint8, valid bool) Uint8 {
	return Uint8{
		NullUint8: NullUint8{
			Uint8: i,
			Valid: valid,
...
func (i *Uint8) UnmarshalJSON(data []byte) error {
	...
	case nil:
		...
		return nil
	default:
		err = errors.NewNotValidf("[null] json: cannot unmarshal %#v into Go value of type null.Uint8", v)
	}
	i.Valid = err == nil
	return err
}
