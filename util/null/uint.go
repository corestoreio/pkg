...
// MakeUint creates a new Uint
func MakeUint(i uint, valid bool) Uint {
	return Uint{
		NullUint: NullUint{
			Uint:  i,
			Valid: valid,
...
func (i *Uint) UnmarshalJSON(data []byte) error {
	...
	case nil:
		...
		return nil
	default:
		err = errors.NewNotValidf("[null] json: cannot unmarshal %#v into Go value of type null.Uint", v)
	}
	i.Valid = err == nil
	return err
}
