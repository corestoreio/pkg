...
func MakeInt32(i int32, valid bool) Int32 {
	return Int32{
		NullInt32: NullInt32{
			Int32: i,
			Valid: valid,
...
func (i *Int32) UnmarshalJSON(data []byte) error {
	...
	case nil:
		...
		return nil
	default:
		err = errors.NewNotValidf("[null] json: cannot unmarshal %#v into Go value of type null.Int32", v)
	}
	i.Valid = err == nil
	return err
}
