...
func MakeInt8(i int8, valid bool) Int8 {
	return Int8{
		NullInt8: NullInt8{
			Int8:  i,
			Valid: valid,
...
func (i *Int8) UnmarshalJSON(data []byte) error {
	...
	case nil:
		...
		return nil
	default:
		err = errors.NewNotValidf("[null] json: cannot unmarshal %#v into Go value of type null.Int8", v)
	}
	i.Valid = err == nil
	return err
}
