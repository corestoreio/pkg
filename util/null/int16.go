...
func MakeInt16(i int16, valid bool) Int16 {
	return Int16{
		NullInt16: NullInt16{
			Int16: i,
			Valid: valid,
...
func (i *Int16) UnmarshalJSON(data []byte) error {
	...
	case nil:
		...
		return nil
	default:
		err = errors.NewNotValidf("[null] json: cannot unmarshal %#v into Go value of type null.Int16", v)
	}
	i.Valid = err == nil
	return err
}
