...
func (pp *PkgBackend) init(cfgStruct element.SectionSlice) *PkgBackend {
	pp.Lock()
	defer pp.Unlock()
	pp.TransEmailIdentCustom1Email = model.NewStr(`trans_email/ident_custom1/email`, model.WithFieldFromSectionSlice(cfgStruct))
	pp.TransEmailIdentCustom1Name = model.NewStr(`trans_email/ident_custom1/name`, model.WithFieldFromSectionSlice(cfgStruct))
	pp.TransEmailIdentCustom2Email = model.NewStr(`trans_email/ident_custom2/email`, model.WithFieldFromSectionSlice(cfgStruct))
	pp.TransEmailIdentCustom2Name = model.NewStr(`trans_email/ident_custom2/name`, model.WithFieldFromSectionSlice(cfgStruct))
	pp.TransEmailIdentGeneralEmail = model.NewStr(`trans_email/ident_general/email`, model.WithFieldFromSectionSlice(cfgStruct))
	pp.TransEmailIdentGeneralName = model.NewStr(`trans_email/ident_general/name`, model.WithFieldFromSectionSlice(cfgStruct))
	pp.TransEmailIdentSalesEmail = model.NewStr(`trans_email/ident_sales/email`, model.WithFieldFromSectionSlice(cfgStruct))
	pp.TransEmailIdentSalesName = model.NewStr(`trans_email/ident_sales/name`, model.WithFieldFromSectionSlice(cfgStruct))
	pp.TransEmailIdentSupportEmail = model.NewStr(`trans_email/ident_support/email`, model.WithFieldFromSectionSlice(cfgStruct))
	pp.TransEmailIdentSupportName = model.NewStr(`trans_email/ident_support/name`, model.WithFieldFromSectionSlice(cfgStruct))
	pp.DesignThemeThemeID = model.NewStr(`design/theme/theme_id`, model.WithFieldFromSectionSlice(cfgStruct))
	pp.DesignThemeUaRegexp = model.NewStr(`design/theme/ua_regexp`, model.WithFieldFromSectionSlice(cfgStruct))
	pp.DesignPaginationPaginationFrame = model.NewStr(`design/pagination/pagination_frame`, model.WithFieldFromSectionSlice(cfgStruct))
	pp.DesignPaginationPaginationFrameSkip = model.NewStr(`design/pagination/pagination_frame_skip`, model.WithFieldFromSectionSlice(cfgStruct))
	pp.DesignPaginationAnchorTextForPrevious = model.NewStr(`design/pagination/anchor_text_for_previous`, model.WithFieldFromSectionSlice(cfgStruct))
	pp.DesignPaginationAnchorTextForNext = model.NewStr(`design/pagination/anchor_text_for_next`, model.WithFieldFromSectionSlice(cfgStruct))
	pp.DevDebugTemplateHintsStorefront = model.NewBool(`dev/debug/template_hints_storefront`, model.WithFieldFromSectionSlice(cfgStruct), model.WithSource(source.YesNo))
	pp.DevDebugTemplateHintsAdmin = model.NewBool(`dev/debug/template_hints_admin`, model.WithFieldFromSectionSlice(cfgStruct), model.WithSource(source.YesNo))
	pp.DevDebugTemplateHintsBlocks = model.NewBool(`dev/debug/template_hints_blocks`, model.WithFieldFromSectionSlice(cfgStruct), model.WithSource(source.YesNo))
	pp.DevTemplateAllowSymlink = model.NewBool(`dev/template/allow_symlink`, model.WithFieldFromSectionSlice(cfgStruct), model.WithSource(source.YesNo))
	pp.DevTemplateMinifyHTML = model.NewBool(`dev/template/minify_html`, model.WithFieldFromSectionSlice(cfgStruct), model.WithSource(source.YesNo))
	pp.DevTranslateInlineActive = model.NewBool(`dev/translate_inline/active`, model.WithFieldFromSectionSlice(cfgStruct), model.WithSource(source.YesNo))
	pp.DevTranslateInlineActiveAdmin = model.NewBool(`dev/translate_inline/active_admin`, model.WithFieldFromSectionSlice(cfgStruct), model.WithSource(source.YesNo))
	pp.DevJsMergeFiles = model.NewBool(`dev/js/merge_files`, model.WithFieldFromSectionSlice(cfgStruct), model.WithSource(source.YesNo))
	pp.DevJsEnableJsBundling = model.NewBool(`dev/js/enable_js_bundling`, model.WithFieldFromSectionSlice(cfgStruct), model.WithSource(source.YesNo))
	pp.DevJsMinifyFiles = model.NewBool(`dev/js/minify_files`, model.WithFieldFromSectionSlice(cfgStruct), model.WithSource(source.YesNo))
	pp.DevCSSMergeCSSFiles = model.NewBool(`dev/css/merge_css_files`, model.WithFieldFromSectionSlice(cfgStruct), model.WithSource(source.YesNo))
	pp.DevCSSMinifyFiles = model.NewBool(`dev/css/minify_files`, model.WithFieldFromSectionSlice(cfgStruct), model.WithSource(source.YesNo))
	pp.DevImageDefaultAdapter = model.NewStr(`dev/image/default_adapter`, model.WithFieldFromSectionSlice(cfgStruct))
	pp.DevStaticSign = model.NewBool(`dev/static/sign`, model.WithFieldFromSectionSlice(cfgStruct), model.WithSource(source.YesNo))
	pp.GeneralStoreInformationName = model.NewStr(`general/store_information/name`, model.WithFieldFromSectionSlice(cfgStruct))
	pp.GeneralStoreInformationPhone = model.NewStr(`general/store_information/phone`, model.WithFieldFromSectionSlice(cfgStruct))
	pp.GeneralStoreInformationHours = model.NewStr(`general/store_information/hours`, model.WithFieldFromSectionSlice(cfgStruct))
	pp.GeneralStoreInformationCountryID = model.NewStr(`general/store_information/country_id`, model.WithFieldFromSectionSlice(cfgStruct))
	pp.GeneralStoreInformationRegionID = model.NewStr(`general/store_information/region_id`, model.WithFieldFromSectionSlice(cfgStruct))
	pp.GeneralStoreInformationPostcode = model.NewStr(`general/store_information/postcode`, model.WithFieldFromSectionSlice(cfgStruct))
	pp.GeneralStoreInformationCity = model.NewStr(`general/store_information/city`, model.WithFieldFromSectionSlice(cfgStruct))
	pp.GeneralStoreInformationStreetLine1 = model.NewStr(`general/store_information/street_line1`, model.WithFieldFromSectionSlice(cfgStruct))
	pp.GeneralStoreInformationStreetLine2 = model.NewStr(`general/store_information/street_line2`, model.WithFieldFromSectionSlice(cfgStruct))
	pp.GeneralStoreInformationMerchantVatNumber = model.NewStr(`general/store_information/merchant_vat_number`, model.WithFieldFromSectionSlice(cfgStruct))
	pp.GeneralSingleStoreModeEnabled = model.NewBool(`general/single_store_mode/enabled`, model.WithFieldFromSectionSlice(cfgStruct), model.WithSource(source.EnableDisable))
	pp.SystemSMTPDisable = model.NewBool(`system/smtp/disable`, model.WithFieldFromSectionSlice(cfgStruct), model.WithSource(source.EnableDisable))
	pp.SystemSMTPHost = model.NewStr(`system/smtp/host`, model.WithFieldFromSectionSlice(cfgStruct))
	pp.SystemSMTPPort = model.NewStr(`system/smtp/port`, model.WithFieldFromSectionSlice(cfgStruct))
	pp.SystemSMTPSetReturnPath = model.NewBool(`system/smtp/set_return_path`, model.WithFieldFromSectionSlice(cfgStruct), model.WithSource(source.YesNo))
	pp.SystemSMTPReturnPathEmail = model.NewStr(`system/smtp/return_path_email`, model.WithFieldFromSectionSlice(cfgStruct))
	pp.AdminEmailsForgotEmailTemplate = model.NewStr(`admin/emails/forgot_email_template`, model.WithFieldFromSectionSlice(cfgStruct))
	pp.AdminEmailsForgotEmailIdentity = model.NewStr(`admin/emails/forgot_email_identity`, model.WithFieldFromSectionSlice(cfgStruct))
	pp.AdminEmailsPasswordResetLinkExpirationPeriod = model.NewStr(`admin/emails/password_reset_link_expiration_period`, model.WithFieldFromSectionSlice(cfgStruct))
	pp.AdminStartupMenuItemID = model.NewStr(`admin/startup/menu_item_id`, model.WithFieldFromSectionSlice(cfgStruct))
	pp.AdminURLUseCustom = model.NewBool(`admin/url/use_custom`, model.WithFieldFromSectionSlice(cfgStruct), model.WithSource(source.YesNo))
	pp.AdminURLCustom = model.NewStr(`admin/url/custom`, model.WithFieldFromSectionSlice(cfgStruct))
	pp.AdminURLUseCustomPath = model.NewBool(`admin/url/use_custom_path`, model.WithFieldFromSectionSlice(cfgStruct), model.WithSource(source.YesNo))
	pp.AdminURLCustomPath = model.NewStr(`admin/url/custom_path`, model.WithFieldFromSectionSlice(cfgStruct))
	pp.AdminSecurityUseFormKey = model.NewBool(`admin/security/use_form_key`, model.WithFieldFromSectionSlice(cfgStruct))
	pp.AdminSecurityUseCaseSensitiveLogin = model.NewBool(`admin/security/use_case_sensitive_login`, model.WithFieldFromSectionSlice(cfgStruct), model.WithSource(source.YesNo))
	pp.AdminSecuritySessionLifetime = model.NewStr(`admin/security/session_lifetime`, model.WithFieldFromSectionSlice(cfgStruct))
	pp.AdminDashboardEnableCharts = model.NewBool(`admin/dashboard/enable_charts`, model.WithFieldFromSectionSlice(cfgStruct), model.WithSource(source.YesNo))
	pp.WebURLUseStore = model.NewBool(`web/url/use_store`, model.WithFieldFromSectionSlice(cfgStruct))
	pp.WebURLRedirectToBase = NewConfigRedirectToBase(`web/url/redirect_to_base`, model.WithFieldFromSectionSlice(cfgStruct))
	pp.WebSeoUseRewrites = model.NewBool(`web/seo/use_rewrites`, model.WithFieldFromSectionSlice(cfgStruct), model.WithSource(source.YesNo))
	pp.WebUnsecureBaseURL = model.NewBaseURL(`web/unsecure/base_url`, model.WithFieldFromSectionSlice(cfgStruct))
	pp.WebUnsecureBaseLinkURL = model.NewBaseURL(`web/unsecure/base_link_url`, model.WithFieldFromSectionSlice(cfgStruct))
	pp.WebUnsecureBaseStaticURL = model.NewBaseURL(`web/unsecure/base_static_url`, model.WithFieldFromSectionSlice(cfgStruct))
	pp.WebUnsecureBaseMediaURL = model.NewBaseURL(`web/unsecure/base_media_url`, model.WithFieldFromSectionSlice(cfgStruct))
	pp.WebSecureBaseURL = model.NewBaseURL(`web/secure/base_url`, model.WithFieldFromSectionSlice(cfgStruct))
	pp.WebSecureBaseLinkURL = model.NewBaseURL(`web/secure/base_link_url`, model.WithFieldFromSectionSlice(cfgStruct))
	pp.WebSecureBaseStaticURL = model.NewBaseURL(`web/secure/base_static_url`, model.WithFieldFromSectionSlice(cfgStruct))
	pp.WebSecureBaseMediaURL = model.NewBaseURL(`web/secure/base_media_url`, model.WithFieldFromSectionSlice(cfgStruct))
	pp.WebSecureUseInFrontend = model.NewBool(`web/secure/use_in_frontend`, model.WithFieldFromSectionSlice(cfgStruct), model.WithSource(source.YesNo))
	pp.WebSecureUseInAdminhtml = model.NewBool(`web/secure/use_in_adminhtml`, model.WithFieldFromSectionSlice(cfgStruct), model.WithSource(source.YesNo))
	pp.WebSecureEnableHsts = model.NewBool(`web/secure/enable_hsts`, model.WithFieldFromSectionSlice(cfgStruct))
	pp.WebSecureEnableUpgradeInsecure = model.NewBool(`web/secure/enable_upgrade_insecure`, model.WithFieldFromSectionSlice(cfgStruct))
	pp.WebSecureOffloaderHeader = model.NewStr(`web/secure/offloader_header`, model.WithFieldFromSectionSlice(cfgStruct))
	pp.WebDefaultFront = model.NewStr(`web/default/front`, model.WithFieldFromSectionSlice(cfgStruct))
	pp.WebDefaultNoRoute = model.NewStr(`web/default/no_route`, model.WithFieldFromSectionSlice(cfgStruct))
	pp.WebSessionUseRemoteAddr = model.NewBool(`web/session/use_remote_addr`, model.WithFieldFromSectionSlice(cfgStruct), model.WithSource(source.YesNo))
	pp.WebSessionUseHTTPVia = model.NewBool(`web/session/use_http_via`, model.WithFieldFromSectionSlice(cfgStruct), model.WithSource(source.YesNo))
	pp.WebSessionUseHTTPXForwardedFor = model.NewBool(`web/session/use_http_x_forwarded_for`, model.WithFieldFromSectionSlice(cfgStruct), model.WithSource(source.YesNo))
	pp.WebSessionUseHTTPUserAgent = model.NewBool(`web/session/use_http_user_agent`, model.WithFieldFromSectionSlice(cfgStruct), model.WithSource(source.YesNo))
	pp.WebSessionUseFrontendSid = model.NewBool(`web/session/use_frontend_sid`, model.WithFieldFromSectionSlice(cfgStruct), model.WithSource(source.YesNo))
