...
func TestGetGoPrimitive(t *testing.T) {
	...
	tests := []struct {
		...
		{ddl.Column{Field: `some_currencies_242`, DataType: `decimal`, Default: dml.MakeNullString(`0.0000`)}, "dml.Decimal"},
		{ddl.Column{Field: `weight_252`, DataType: `decimal`, Null: "YES", Default: dml.MakeNullString(`0.0000`)}, "dml.Decimal"},
