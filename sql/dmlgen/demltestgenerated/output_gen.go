...
// tables: [catalog_product_index_eav_decimal_idx core_config_data customer_address_entity customer_entity dmlgen_types sales_order_status_state view_customer_auto_increment view_customer_no_auto_increment]
	...
	if tm, err = ddl.NewTables(
		append(opts,
			ddl.WithCreateTable(ctx,
				TableNameCatalogProductIndexEAVDecimalIDX, "",
				TableNameCoreConfigData, "",
				TableNameCustomerAddressEntity, "",
				TableNameCustomerEntity, "",
				TableNameDmlgenTypes, "",
				TableNameSalesOrderStatusState, "",
				TableNameViewCustomerAutoIncrement, "",
				TableNameViewCustomerNoAutoIncrement, ""),
		)...,
	); err != nil {
...
// CatalogProductIndexEAVDecimalIDXCollection represents a collection type for DB table catalog_product_index_eav_decimal_idx
...
// NewCatalogProductIndexEAVDecimalIDXCollection creates a new initialized collection. Auto generated.
...
// AttributeIDs returns a slice or appends to a slice all values.
// Auto generated.
...
// StoreIDs returns a slice or appends to a slice all values.
// Auto generated.
...
// Values returns a slice or appends to a slice all values.
// Auto generated.
...
// SourceIDs returns a slice or appends to a slice all values.
// Auto generated.
...
// Empty empties all the fields of the current object. Also known as Reset.
func (e *CustomerAddressEntity) Empty() *CustomerAddressEntity { *e = CustomerAddressEntity{}; return e }

// CustomerAddressEntityCollection represents a collection type for DB table customer_address_entity
// Not thread safe. Auto generated.
...
// NewCustomerAddressEntityCollection creates a new initialized collection. Auto generated.
...
// Each will run function f on all items in []*CustomerAddressEntity.
// Auto generated via dmlgen.
...
// Empty empties all the fields of the current object. Also known as Reset.
func (e *SalesOrderStatusState) Empty() *SalesOrderStatusState { *e = SalesOrderStatusState{}; return e }

// SalesOrderStatusStateCollection represents a collection type for DB table sales_order_status_state
// Not thread safe. Auto generated.
...
// NewSalesOrderStatusStateCollection creates a new initialized collection. Auto generated.
...
// Statuss returns a slice or appends to a slice all values.
// Auto generated.
...
// States returns a slice or appends to a slice all values.
// Auto generated.
...
// Each will run function f on all items in []*SalesOrderStatusState.
// Auto generated via dmlgen.
...
// ViewCustomerAutoIncrementCollection represents a collection type for DB table view_customer_auto_increment
// Not thread safe. Auto generated.
...
// NewViewCustomerAutoIncrementCollection creates a new initialized collection. Auto generated.
...
// Each will run function f on all items in []*ViewCustomerAutoIncrement.
// Auto generated via dmlgen.
...
// ViewCustomerNoAutoIncrementCollection represents a collection type for DB table view_customer_no_auto_increment
// Not thread safe. Auto generated.
...
// NewViewCustomerNoAutoIncrementCollection creates a new initialized collection. Auto generated.
...
// Append will add a new item at the end of *ViewCustomerNoAutoIncrementCollection.
// Auto generated via dmlgen.
