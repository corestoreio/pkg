...
// CategoryAttributeBackendSortby sorting @todo
// @see magento2/site/app/code/Magento/Catalog/Model/Category/Attribute/Backend/Sortby.php
func CategoryAttributeBackendSortby() *todoCABSB {
	return &todoCABSB{}
}

// CategoryAttributeBackendImage @todo file uploading and saving
// @see magento2/site/app/code/Magento/Catalog/Model/Category/Attribute/Backend/Image.php
func CategoryAttributeBackendImage() *todoCABI {
	return &todoCABI{}
}
