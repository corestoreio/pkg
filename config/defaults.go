...
const (
	...
	SingleStoreModeEnabled = "general/single_store_mode/enabled"
)

func init() {
	cfgDefault.SetDefault(SingleStoreModeEnabled, false)
	cfgStore.SetDefault(SingleStoreModeEnabled, false)
}
