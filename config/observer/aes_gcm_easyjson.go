...
func easyjson4cfa51e5EncodeGithubComCorestoreioPkgConfigObserver(out *jwriter.Writer, in AESGCMOptions) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Key != "" {
...
func (v AESGCMOptions) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson4cfa51e5EncodeGithubComCorestoreioPkgConfigObserver(&w, v)
...
func (v *AESGCMOptions) UnmarshalJSON(data []byte) error {
	...
	easyjson4cfa51e5DecodeGithubComCorestoreioPkgConfigObserver(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *AESGCMOptions) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson4cfa51e5DecodeGithubComCorestoreioPkgConfigObserver(l, v)
}
