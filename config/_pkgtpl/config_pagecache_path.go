...
var PathSystemFullPageCacheCachingApplication = model.NewStr(`system/full_page_cache/caching_application`, model.WithPkgCfg(PackageConfiguration))
...
var PathSystemFullPageCacheTtl = model.NewStr(`system/full_page_cache/ttl`, model.WithPkgCfg(PackageConfiguration))
