...
func (pp *PkgBackend) init(cfgStruct element.SectionSlice) *PkgBackend {
	pp.Lock()
	defer pp.Unlock()
	pp.CarriersDhlActive = model.NewBool(`carriers/dhl/active`, model.WithFieldFromSectionSlice(cfgStruct))
	pp.CarriersDhlActiveRma = model.NewBool(`carriers/dhl/active_rma`, model.WithFieldFromSectionSlice(cfgStruct))
	pp.CarriersDhlGatewayUrl = model.NewStr(`carriers/dhl/gateway_url`, model.WithFieldFromSectionSlice(cfgStruct))
	pp.CarriersDhlTitle = model.NewStr(`carriers/dhl/title`, model.WithFieldFromSectionSlice(cfgStruct))
	pp.CarriersDhlId = model.NewStr(`carriers/dhl/id`, model.WithFieldFromSectionSlice(cfgStruct))
	pp.CarriersDhlPassword = model.NewStr(`carriers/dhl/password`, model.WithFieldFromSectionSlice(cfgStruct))
	pp.CarriersDhlAccount = model.NewStr(`carriers/dhl/account`, model.WithFieldFromSectionSlice(cfgStruct))
	pp.CarriersDhlContentType = model.NewStr(`carriers/dhl/content_type`, model.WithFieldFromSectionSlice(cfgStruct))
	pp.CarriersDhlHandlingType = model.NewStr(`carriers/dhl/handling_type`, model.WithFieldFromSectionSlice(cfgStruct))
	pp.CarriersDhlHandlingAction = model.NewStr(`carriers/dhl/handling_action`, model.WithFieldFromSectionSlice(cfgStruct))
	pp.CarriersDhlHandlingFee = model.NewStr(`carriers/dhl/handling_fee`, model.WithFieldFromSectionSlice(cfgStruct))
	pp.CarriersDhlDivideOrderWeight = model.NewBool(`carriers/dhl/divide_order_weight`, model.WithFieldFromSectionSlice(cfgStruct))
	pp.CarriersDhlUnitOfMeasure = model.NewStr(`carriers/dhl/unit_of_measure`, model.WithFieldFromSectionSlice(cfgStruct))
	pp.CarriersDhlSize = model.NewStr(`carriers/dhl/size`, model.WithFieldFromSectionSlice(cfgStruct))
	pp.CarriersDhlHeight = model.NewStr(`carriers/dhl/height`, model.WithFieldFromSectionSlice(cfgStruct))
	pp.CarriersDhlDepth = model.NewStr(`carriers/dhl/depth`, model.WithFieldFromSectionSlice(cfgStruct))
	pp.CarriersDhlWidth = model.NewStr(`carriers/dhl/width`, model.WithFieldFromSectionSlice(cfgStruct))
	pp.CarriersDhlDocMethods = model.NewStringCSV(`carriers/dhl/doc_methods`, model.WithFieldFromSectionSlice(cfgStruct))
	pp.CarriersDhlNondocMethods = model.NewStringCSV(`carriers/dhl/nondoc_methods`, model.WithFieldFromSectionSlice(cfgStruct))
	pp.CarriersDhlReadyTime = model.NewStr(`carriers/dhl/ready_time`, model.WithFieldFromSectionSlice(cfgStruct))
	pp.CarriersDhlSpecificerrmsg = model.NewStr(`carriers/dhl/specificerrmsg`, model.WithFieldFromSectionSlice(cfgStruct))
	pp.CarriersDhlFreeMethodDoc = model.NewStr(`carriers/dhl/free_method_doc`, model.WithFieldFromSectionSlice(cfgStruct))
	pp.CarriersDhlFreeMethodNondoc = model.NewStr(`carriers/dhl/free_method_nondoc`, model.WithFieldFromSectionSlice(cfgStruct))
	pp.CarriersDhlFreeShippingEnable = model.NewBool(`carriers/dhl/free_shipping_enable`, model.WithFieldFromSectionSlice(cfgStruct))
	pp.CarriersDhlFreeShippingSubtotal = model.NewStr(`carriers/dhl/free_shipping_subtotal`, model.WithFieldFromSectionSlice(cfgStruct))
	pp.CarriersDhlSallowspecific = model.NewStr(`carriers/dhl/sallowspecific`, model.WithFieldFromSectionSlice(cfgStruct))
	pp.CarriersDhlSpecificcountry = model.NewStringCSV(`carriers/dhl/specificcountry`, model.WithFieldFromSectionSlice(cfgStruct))
	pp.CarriersDhlShowmethod = model.NewBool(`carriers/dhl/showmethod`, model.WithFieldFromSectionSlice(cfgStruct))
	pp.CarriersDhlSortOrder = model.NewStr(`carriers/dhl/sort_order`, model.WithFieldFromSectionSlice(cfgStruct))
	pp.CarriersDhlDebug = model.NewBool(`carriers/dhl/debug`, model.WithFieldFromSectionSlice(cfgStruct))
