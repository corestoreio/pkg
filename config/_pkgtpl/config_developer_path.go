...
var PathDevFrontEndDevelopmentWorkflowType = model.NewStr(`dev/front_end_development_workflow/type`)
...
var PathDevRestrictAllowIps = model.NewStr(`dev/restrict/allow_ips`)
