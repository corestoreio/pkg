...
func (pp *PkgBackend) init(cfgStruct element.SectionSlice) *PkgBackend {
	pp.Lock()
	defer pp.Unlock()
	pp.CarriersUpsAccessLicenseNumber = model.NewStr(`carriers/ups/access_license_number`, model.WithFieldFromSectionSlice(cfgStruct))
	pp.CarriersUpsActive = model.NewBool(`carriers/ups/active`, model.WithFieldFromSectionSlice(cfgStruct))
	pp.CarriersUpsActiveRma = model.NewBool(`carriers/ups/active_rma`, model.WithFieldFromSectionSlice(cfgStruct))
	pp.CarriersUpsAllowedMethods = model.NewStringCSV(`carriers/ups/allowed_methods`, model.WithFieldFromSectionSlice(cfgStruct))
	pp.CarriersUpsShipmentRequesttype = model.NewStr(`carriers/ups/shipment_requesttype`, model.WithFieldFromSectionSlice(cfgStruct))
	pp.CarriersUpsContainer = model.NewStr(`carriers/ups/container`, model.WithFieldFromSectionSlice(cfgStruct))
	pp.CarriersUpsFreeShippingEnable = model.NewBool(`carriers/ups/free_shipping_enable`, model.WithFieldFromSectionSlice(cfgStruct))
	pp.CarriersUpsFreeShippingSubtotal = model.NewStr(`carriers/ups/free_shipping_subtotal`, model.WithFieldFromSectionSlice(cfgStruct))
	pp.CarriersUpsDestType = model.NewStr(`carriers/ups/dest_type`, model.WithFieldFromSectionSlice(cfgStruct))
	pp.CarriersUpsFreeMethod = model.NewStr(`carriers/ups/free_method`, model.WithFieldFromSectionSlice(cfgStruct))
	pp.CarriersUpsGatewayUrl = model.NewStr(`carriers/ups/gateway_url`, model.WithFieldFromSectionSlice(cfgStruct))
	pp.CarriersUpsGatewayXmlUrl = model.NewStr(`carriers/ups/gateway_xml_url`, model.WithFieldFromSectionSlice(cfgStruct))
	pp.CarriersUpsHandlingType = model.NewStr(`carriers/ups/handling_type`, model.WithFieldFromSectionSlice(cfgStruct))
	pp.CarriersUpsHandlingAction = model.NewStr(`carriers/ups/handling_action`, model.WithFieldFromSectionSlice(cfgStruct))
	pp.CarriersUpsHandlingFee = model.NewStr(`carriers/ups/handling_fee`, model.WithFieldFromSectionSlice(cfgStruct))
	pp.CarriersUpsMaxPackageWeight = model.NewStr(`carriers/ups/max_package_weight`, model.WithFieldFromSectionSlice(cfgStruct))
	pp.CarriersUpsMinPackageWeight = model.NewStr(`carriers/ups/min_package_weight`, model.WithFieldFromSectionSlice(cfgStruct))
	pp.CarriersUpsOriginShipment = model.NewStr(`carriers/ups/origin_shipment`, model.WithFieldFromSectionSlice(cfgStruct))
	pp.CarriersUpsPassword = model.NewStr(`carriers/ups/password`, model.WithFieldFromSectionSlice(cfgStruct))
	pp.CarriersUpsPickup = model.NewStr(`carriers/ups/pickup`, model.WithFieldFromSectionSlice(cfgStruct))
	pp.CarriersUpsSortOrder = model.NewStr(`carriers/ups/sort_order`, model.WithFieldFromSectionSlice(cfgStruct))
	pp.CarriersUpsTitle = model.NewStr(`carriers/ups/title`, model.WithFieldFromSectionSlice(cfgStruct))
	pp.CarriersUpsTrackingXmlUrl = model.NewStr(`carriers/ups/tracking_xml_url`, model.WithFieldFromSectionSlice(cfgStruct))
	pp.CarriersUpsType = model.NewStr(`carriers/ups/type`, model.WithFieldFromSectionSlice(cfgStruct))
	pp.CarriersUpsIsAccountLive = model.NewBool(`carriers/ups/is_account_live`, model.WithFieldFromSectionSlice(cfgStruct))
	pp.CarriersUpsUnitOfMeasure = model.NewStr(`carriers/ups/unit_of_measure`, model.WithFieldFromSectionSlice(cfgStruct))
	pp.CarriersUpsUsername = model.NewStr(`carriers/ups/username`, model.WithFieldFromSectionSlice(cfgStruct))
	pp.CarriersUpsNegotiatedActive = model.NewBool(`carriers/ups/negotiated_active`, model.WithFieldFromSectionSlice(cfgStruct))
	pp.CarriersUpsShipperNumber = model.NewStr(`carriers/ups/shipper_number`, model.WithFieldFromSectionSlice(cfgStruct))
	pp.CarriersUpsSallowspecific = model.NewStr(`carriers/ups/sallowspecific`, model.WithFieldFromSectionSlice(cfgStruct))
	pp.CarriersUpsSpecificcountry = model.NewStringCSV(`carriers/ups/specificcountry`, model.WithFieldFromSectionSlice(cfgStruct))
	pp.CarriersUpsShowmethod = model.NewBool(`carriers/ups/showmethod`, model.WithFieldFromSectionSlice(cfgStruct))
	pp.CarriersUpsSpecificerrmsg = model.NewStr(`carriers/ups/specificerrmsg`, model.WithFieldFromSectionSlice(cfgStruct))
	pp.CarriersUpsModeXml = model.NewStr(`carriers/ups/mode_xml`, model.WithFieldFromSectionSlice(cfgStruct))
	pp.CarriersUpsDebug = model.NewBool(`carriers/ups/debug`, model.WithFieldFromSectionSlice(cfgStruct))
