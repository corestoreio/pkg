...
CtxRouter is a lightweight high performance HTTP request router (also called *multiplexer* or just *mux* for short) for [Go](https://golang.org/).
...
Just try it out for yourself, the usage of CtxRouter is very straightforward. The package is compact and minimalistic, but also probably one of the easiest routers to set up.
...
Alternatively, you could try [a web framework based on CtxRouter](#web-frameworks-based-on-httprouter).
...
## Web Frameworks based on CtxRouter

If the CtxRouter is a bit too minimalistic for you, you might try one of the following more high-level 3rd-party web frameworks building upon the CtxRouter package:
