...
CtxRouter is a lightweight high performance HTTP request router
...
[net/context](https://github.com/golang/net/tree/master/context) in the routing pattern and matches against the request method.
...
features. The router is just a [ctxhttp.Handler](https://godoc.org/github.com/corestoreio/csfw/net/ctxhttp),
you can chain any ctxhttp.Handler compatible middleware before the router,
...
### Basic Authentication todo for ctxhttp.Handler
