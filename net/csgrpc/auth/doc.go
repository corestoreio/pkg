...
//
// The middleware takes a user-customizable `AuthFunc`, which can be customized
// to verify and extract auth information from the request. The extracted
// information can be put in the `context.Context` of handlers downstream for
// retrieval.
//
