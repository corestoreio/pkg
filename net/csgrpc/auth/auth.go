...
//
// If error is returned, its `grpc.Code()` will be returned to the user as well
// as the verbatim message. Please make sure you use `codes.Unauthenticated`
// (lacking auth) and `codes.PermissionDenied` (authed, but lacking perms)
// appropriately.
