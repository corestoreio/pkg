...
//	storage map[scope.Hash]*Service
//	// under very very high load this map will become a bottle neck so we
//	// should switch to a lock free data structure.
//}
//
//func newScopeCache(parent *Service) *scopeCache {
//	return &scopeCache{
//		parent:  parent,
//		storage: make(map[scope.Hash]*Service),
//	}
//}
//
...
//func (cs *scopeCache) get(s scope.Scope, id int64) *Service {
//	cs.rwmu.RLock()
...
//func (cs *scopeCache) insert(sg config.ScopedGetter) (*Service, error) {
//	cs.rwmu.Lock()
