...
//
// var serviceStoreSimpleTest = MustNewService(
// 	cfgmock.NewService(),
// 	WithTableWebsites(&TableWebsite{WebsiteID: 1, Code: null.StringFrom("euro"), Name: null.StringFrom("Europe"), SortOrder: 0, DefaultGroupID: 1, IsDefault: null.BoolFrom(true)}),
// 	WithTableGroups(&TableGroup{GroupID: 1, WebsiteID: 1, Name: "DACH Group", RootCategoryID: 2, DefaultStoreID: 2}),
// 	WithTableStores(&TableStore{StoreID: 1, Code: null.StringFrom("de"), WebsiteID: 1, GroupID: 1, Name: "Germany", SortOrder: 10, IsActive: true}),
// )
//
...
// 		}
// 	}()
// 	_ = MustNewService(cfgmock.NewService(),
// 		WithTableWebsites(&TableWebsite{WebsiteID: 1, Code: null.StringFrom("euro"), Name: null.StringFrom("Europe"), SortOrder: 0, DefaultGroupID: 1, IsDefault: null.BoolFrom(true)}),
// 		WithTableGroups(&TableGroup{GroupID: 1, WebsiteID: 0, Name: "DACH Group", RootCategoryID: 2, DefaultStoreID: 2}),
// 	)
// }
//
...
// 		{0, errors.IsNotFound},
// 	}
// 	serviceEmpty := MustNewService(cfgmock.NewService(),
// 		WithTableWebsites(&TableWebsite{WebsiteID: 1, Code: null.StringFrom("euro"), Name: null.StringFrom("Europe"), SortOrder: 0, DefaultGroupID: 1, IsDefault: null.BoolFrom(true)}),
// 	)
...
//
// 	s, err := NewService(cfgmock.NewService(),
// 		WithTableWebsites(&TableWebsite{WebsiteID: 1, Code: null.StringFrom("euro"), IsDefault: null.BoolFrom(true)}),
// 		WithTableWebsites(&TableWebsite{WebsiteID: 12, Code: null.StringFrom("euro2"), IsDefault: null.BoolFrom(true)}),
// 	)
// 	assert.Nil(t, s)
// 	assert.True(t, errors.IsNotValid(err), "%+v", err)
// }
...
//
// 	serviceDefaultStore := MustNewService(
// 		cfgmock.NewService(),
// 		WithTableWebsites(&TableWebsite{WebsiteID: 1, Code: null.StringFrom("euro"), Name: null.StringFrom("Europe"), SortOrder: 0, DefaultGroupID: 1, IsDefault: null.BoolFrom(true)}),
...
// 		WithTableStores(),
// 		WithTableWebsites(&TableWebsite{WebsiteID: 1, Code: null.StringFrom("euro"), Name: null.StringFrom("Europe"), SortOrder: 0, DefaultGroupID: 1, IsDefault: null.BoolFrom(true)}),
// 		WithTableGroups(&TableGroup{GroupID: 10, WebsiteID: 21, Name: "DACH Group", RootCategoryID: 2, DefaultStoreID: 2}),
// 	)
// }
//
// func TestNewService_Group(t *testing.T) {
//
// 	serviceGroupSimpleTest := MustNewService(cfgmock.NewService(),
// 		WithTableWebsites(&TableWebsite{WebsiteID: 1, Code: null.StringFrom("euro"), Name: null.StringFrom("Europe"), SortOrder: 0, DefaultGroupID: 1, IsDefault: null.BoolFrom(true)}),
// 		WithTableGroups(&TableGroup{GroupID: 1, WebsiteID: 1, Name: "DACH Group", RootCategoryID: 2, DefaultStoreID: 2}),
// 		WithTableStores(&TableStore{StoreID: 1, Code: null.StringFrom("de"), WebsiteID: 1, GroupID: 1, Name: "Germany", SortOrder: 10, IsActive: true}),
// 	)
...
//
// 	serviceGroups := MustNewService(cfgmock.NewService(),
// 		WithTableStores(&TableStore{StoreID: 1, Code: null.StringFrom("de"), WebsiteID: 1, GroupID: 1, Name: "Germany", SortOrder: 10, IsActive: true}),
// 		WithTableGroups(&TableGroup{GroupID: 1, WebsiteID: 1, Name: "DACH Group", RootCategoryID: 2, DefaultStoreID: 1}),
// 		WithTableWebsites(&TableWebsite{WebsiteID: 1, Code: null.StringFrom("euro"), Name: null.StringFrom("Europe"), SortOrder: 0, DefaultGroupID: 1, IsDefault: null.BoolFrom(true)}),
// 	)
...
//
// 	serviceWebsite := MustNewService(cfgmock.NewService(),
// 		WithTableWebsites(&TableWebsite{WebsiteID: 1, Code: null.StringFrom("euro"), Name: null.StringFrom("Europe"), SortOrder: 0, DefaultGroupID: 1, IsDefault: null.BoolFrom(true)}),
// 		WithTableGroups(&TableGroup{GroupID: 1, WebsiteID: 1, Name: "DACH Group", RootCategoryID: 2, DefaultStoreID: 2}),
// 		WithTableStores(&TableStore{StoreID: 1, Code: null.StringFrom("de"), WebsiteID: 1, GroupID: 1, Name: "Germany", SortOrder: 10, IsActive: true}),
// 	)
...
// 		WithTableWebsites(
// 			&TableWebsite{WebsiteID: 1, Code: null.StringFrom("euro"), Name: null.StringFrom("European Union"), SortOrder: 0, DefaultGroupID: 1, IsDefault: null.BoolFrom(true)},
// 			&TableWebsite{WebsiteID: 2, Code: null.StringFrom("uk"), Name: null.StringFrom("Britain (without Scotland)"), SortOrder: 0, DefaultGroupID: 2},
// 		),
// 	)
...
// 			WithTableWebsites(&TableWebsite{WebsiteID: 1, Code: null.StringFrom("euro"), Name: null.StringFrom("Europe"), SortOrder: 0, DefaultGroupID: 12, IsDefault: null.BoolFrom(true)}),
// 			WithTableGroups(&TableGroup{GroupID: 1, WebsiteID: 1, Name: "DACH Group", RootCategoryID: 2, DefaultStoreID: 2}),
// 			WithTableStores(&TableStore{StoreID: 1, Code: null.StringFrom("de"), WebsiteID: 1, GroupID: 1, Name: "Germany", SortOrder: 10, IsActive: true}),
...
// 			WithTableWebsites(&TableWebsite{WebsiteID: 1, Code: null.StringFrom("euro"), Name: null.StringFrom("Europe"), SortOrder: 0, DefaultGroupID: 1, IsDefault: null.BoolFrom(true)}),
// 			WithTableGroups(&TableGroup{GroupID: 1, WebsiteID: 1, Name: "DACH Group", RootCategoryID: 2, DefaultStoreID: 1}),
// 			WithTableStores(&TableStore{StoreID: 1, Code: null.StringFrom("de"), WebsiteID: 1, GroupID: 1, Name: "Germany", SortOrder: 10, IsActive: false}),
